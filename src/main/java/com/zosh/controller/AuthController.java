...
public class AuthController {
	...
	public ResponseEntity<AuthResponse> registerUserHandler(@Valid @RequestBody RegisterRequest user) throws UserException{
	        ...
	        createdUser.setRole(UserRole.valueOf(role.toUpperCase()));
