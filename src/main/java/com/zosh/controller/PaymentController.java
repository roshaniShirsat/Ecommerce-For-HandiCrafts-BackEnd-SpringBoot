...
public class PaymentController {
	...
	public PaymentController(OrderService orderService,UserService userService,OrderRepository orderRepository, CartItemService cartItemService) {
	...
	public ResponseEntity<PaymentLinkResponse>createPaymentLink(@PathVariable Long orderId,
		...
		Order order=orderService.findOrderById(orderId);
		 try {
		      ...
		      RazorpayClient razorpay = new RazorpayClient("rzp_test_j76YEjQcbR2gk1", "WYHXHeJVdYD78JnYSyEjekJ1");
...
//		order_id
  ...
  @GetMapping("/payments")
  public ResponseEntity<ApiResponse> redirect(@RequestParam(name="payment_id") String paymentId,@RequestParam("order_id")Long orderId, @RequestHeader("Authorization") String jwt) throws RazorpayException, OrderException {
	  RazorpayClient razorpay = new RazorpayClient("rzp_test_j76YEjQcbR2gk1", "WYHXHeJVdYD78JnYSyEjekJ1");
	  Order order =orderService.findOrderById(orderId);
...
//			order.setOrderItems(order.getOrderItems());
			...
			System.out.println("User Cart Items to remove ---"+user.toString());
			cartItemService.removeCartItemAfterPayment(user.getId());
		}
		...
		new RedirectView("http://localhost:3000/paymet/failed");
		throw new RazorpayException(e.getMessage());
	}
...
//		 try {
//		      // Instantiate a Razorpay client with your key ID and secret
//		      RazorpayClient razorpay = new RazorpayClient("rzp_test_6hU76DzSKHlHZF", "S6eDZ8l4e9nxwZxnT53TuEjV");
//
//		      // Create a JSON object with the payment link request parameters
//		      JSONObject paymentLinkRequest = new JSONObject();
